...
## Project Structure
    ...
    ├── testapiautostorybo_123888  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_123888`
...
2. Clone this repo and `cd testapiautostorybo_123888`
